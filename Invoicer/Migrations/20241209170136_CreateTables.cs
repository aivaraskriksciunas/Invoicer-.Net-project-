        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WholeValuesOnly = table.Column<bool>(type: "boolean", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillableUnits", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId = table.Column<string>(type: "character varying(32)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillableRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BillableRecords_Clients_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillableRecords_ClientId",
                table: "BillableRecords",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_BillableUnits_UserId",
                table: "BillableUnits",
                column: "UserId");
